...
export class StorageInputoutputController {
  ...
  async find(
    ...
    return this.storageRepository.inputoutputs(id).find(filter);
  }
  ...
  async create(
    ...
    return this.storageRepository.inputoutputs(id).create(inputoutput);
  }
  ...
  async patch(
    ...
    return this.storageRepository.inputoutputs(id).patch(inputoutput, where);
  }
  ...
  async delete(
    ...
    return this.storageRepository.inputoutputs(id).delete(where);
  }
}
